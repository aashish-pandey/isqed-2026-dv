...
module uart_tb_top;
  ...
  nexus_uart u_dut (
    ...
    .uart_tx_o      (uart_if_inst.uart_tx_o),
    .uart_rx_i      (uart_if_inst.uart_rx_i),
    .intr_o         (uart_if_inst.intr_o),
    .alert_o        (uart_if_inst.alert_o)
  );
  ...
  initial begin
    #2_000_000;
    $fatal(1, "TIMEOUT: simulation exceeded 2ms");
  end
